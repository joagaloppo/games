...
export default function Footer() {
	...
	return (
		<div className="h-32 flex justify-between items-center">
			<span className="flex items-center text-gray-400 px-4 h-10 border rounded hover:bg-gray-100 hover:text-gray-500 hover:border-gray-300 transition cursor-pointer shadow">
